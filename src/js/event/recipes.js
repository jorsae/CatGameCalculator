...
export function getCraftingRecipes(){
    ...
    // Base
    const rawMaterialA = new craftingItem.CraftingItem(rawMaterialNames[0], 0, 0, rarity.Rarity.RAW, 1);
    const rawMaterialB = new craftingItem.CraftingItem(rawMaterialNames[1], 0, 0, rarity.Rarity.RAW, 2);
    const rawMaterialC = new craftingItem.CraftingItem(rawMaterialNames[2], 0, 0, rarity.Rarity.RAW, 3);
    ...
    const A = new craftingItem.CraftingItem(craftingItemNames[0], 15, 20, rarity.Rarity.COMMON, 5, AReq);
    craftingRecipes.set(A.name, A);
    
    const BReq = [new craftingRequirement.CraftingRequirement(rawMaterialB, 4)];
    const B = new craftingItem.CraftingItem(craftingItemNames[1], 15, 20, rarity.Rarity.COMMON, 6, BReq);
    craftingRecipes.set(B.name, B);
    
    const CReq = [new craftingRequirement.CraftingRequirement(rawMaterialC, 4)];
    const C = new craftingItem.CraftingItem(craftingItemNames[2], 15, 20, rarity.Rarity.COMMON, 7, CReq);
    ...
    const D = new craftingItem.CraftingItem(craftingItemNames[3], 15, 150, rarity.Rarity.RARE, 8, DReq);
    ...
    const E = new craftingItem.CraftingItem(craftingItemNames[4], 30, 200, rarity.Rarity.RARE, 9, EReq);
    ...
    const F = new craftingItem.CraftingItem(craftingItemNames[5], 60, 400, rarity.Rarity.RARE, 10, FReq);
    ...
    const stars = new craftingItem.CraftingItem(craftingItemNames[6], 0, 300, rarity.Rarity.RARE, 11, starsReq);
