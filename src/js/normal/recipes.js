...
export function getCraftingRecipes(){
    ...
    const string = new craftingItem.CraftingItem("String", 5, 50, rarity.Rarity.COMMON, 5, stringReq);
    craftingRecipes.set(string.name, string);
    
    var woodReq = [new craftingRequirement.CraftingRequirement(log, 3)];
    const wood = new craftingItem.CraftingItem("Wood", 5, 50, rarity.Rarity.COMMON, 6, woodReq);
    ...
    const ribbon = new craftingItem.CraftingItem("Ribbon", 15, 100, rarity.Rarity.RARE, 7, ribbonReq);
    craftingRecipes.set(ribbon.name, ribbon);
    
    // Shiny Crafting
    var metalReq = [new craftingRequirement.CraftingRequirement(rock, 3)];
    const metal = new craftingItem.CraftingItem("Metal", 15, 100, rarity.Rarity.COMMON, 8, metalReq);
    ...
    const needles = new craftingItem.CraftingItem("Needles", 30, 200, rarity.Rarity.RARE, 9, needlesReq);
    ...
    const sparkles = new craftingItem.CraftingItem("Sparkles", 60, 300, rarity.Rarity.EPIC, 10, sparklesReq);
    craftingRecipes.set(sparkles.name, sparkles);
    
    // Precious Crafting
    var bronzeReq = [new craftingRequirement.CraftingRequirement(rock, 4)];
    const bronze = new craftingItem.CraftingItem("Bronze", 30, 200, rarity.Rarity.COMMON, 11, bronzeReq);
    ...
    const silver = new craftingItem.CraftingItem("Silver", 120, 300, rarity.Rarity.RARE, 12, silverReq);
    ...
    const gold = new craftingItem.CraftingItem("Gold", 360, 500, rarity.Rarity.EPIC, 13, goldReq);
    craftingRecipes.set(gold.name, gold);
    
    // Jewel Crafting
    var amethystReq = [new craftingRequirement.CraftingRequirement(quartz, 10)];
    const amethyst = new craftingItem.CraftingItem("Amethyst", 60, 300, rarity.Rarity.COMMON, 14, amethystReq);
    ...
    const pendant = new craftingItem.CraftingItem("Pendant", 180, 500, rarity.Rarity.RARE, 15, pendantReq);
    ...
    const necklace = new craftingItem.CraftingItem("Necklace", 760, 500, rarity.Rarity.EPIC, 16, necklaceReq);
    craftingRecipes.set(necklace.name, necklace);
    
    // Magic Crafting
    var orbReq = [new craftingRequirement.CraftingRequirement(quartz, 20)];
    const orb = new craftingItem.CraftingItem("Orb", 60, 300, rarity.Rarity.COMMON, 17, orbReq);
    ...
    const water = new craftingItem.CraftingItem("Water", 360, 800, rarity.Rarity.RARE, 18, waterReq);
    ...
    const fire = new craftingItem.CraftingItem("Fire", 720, 1000, rarity.Rarity.EPIC, 19, fireReq);
    ...
    const waterstone = new craftingItem.CraftingItem("Waterstone", 720, 1500, rarity.Rarity.RARE, 20, waterstoneReq);
    ...
    const firestone = new craftingItem.CraftingItem("Firestone", 720, 1500, rarity.Rarity.EPIC, 21, firestoneReq);
    ...
    const elementstone = new craftingItem.CraftingItem("Elementstone", 1440, 5000, rarity.Rarity.LEGENDARY, 22, elementstoneReq);
    ...
    const artifact = new craftingItem.CraftingItem("Artifact", 4320, 10000, rarity.Rarity.LEGENDARY, 23, artifactReq);
