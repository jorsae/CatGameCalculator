...
export function getCraftingRecipes(){
    ...
    // TODO: Store the categories a more appropriate way.    
    const categories = ['', 'Basic Crafting', 'Shiny Crafting', 'Precious Crafting', 'Jewel Crafting', 'Magic Crafting', 'Ancient Crafting', 'Ruin Crafting'];

    // Base
    const cotton = new craftingItem.CraftingItem("Cotton", categories[0], 0, 0, rarity.Rarity.RAW, 1);
    const log = new craftingItem.CraftingItem("Log", categories[0], 0, 0, rarity.Rarity.RAW, 2);
    const rock = new craftingItem.CraftingItem("Rock", categories[0], 0, 0, rarity.Rarity.RAW, 3);
    const quartz = new craftingItem.CraftingItem("Quartz", categories[0], 0, 0, rarity.Rarity.RAW, 4);
    ...
    const string = new craftingItem.CraftingItem("String", categories[1], 50, 5, rarity.Rarity.COMMON, 5, stringReq);
    craftingRecipes.set(string.name, string);
    
    var woodReq = [new craftingRequirement.CraftingRequirement(log, 3)];
    const wood = new craftingItem.CraftingItem("Wood", categories[1], 50, 5, rarity.Rarity.COMMON, 6, woodReq);
    ...
    const ribbon = new craftingItem.CraftingItem("Ribbon", categories[1], 100, 15, rarity.Rarity.RARE, 7, ribbonReq);
    craftingRecipes.set(ribbon.name, ribbon);
    
    // Shiny Crafting
    var metalReq = [new craftingRequirement.CraftingRequirement(rock, 3)];
    const metal = new craftingItem.CraftingItem("Metal", categories[2], 100, 15, rarity.Rarity.COMMON, 8, metalReq);
    ...
    const needles = new craftingItem.CraftingItem("Needles", categories[2], 200, 30, rarity.Rarity.RARE, 9, needlesReq);
    ...
    const sparkles = new craftingItem.CraftingItem("Sparkles", categories[2], 300, 60, rarity.Rarity.EPIC, 10, sparklesReq);
    craftingRecipes.set(sparkles.name, sparkles);
    
    // Precious Crafting
    var bronzeReq = [new craftingRequirement.CraftingRequirement(rock, 4)];
    const bronze = new craftingItem.CraftingItem("Bronze", categories[3], 200, 30, rarity.Rarity.COMMON, 11, bronzeReq);
    ...
    const silver = new craftingItem.CraftingItem("Silver", categories[3], 300, 120, rarity.Rarity.RARE, 12, silverReq);
    ...
    const gold = new craftingItem.CraftingItem("Gold", categories[3], 500, 360, rarity.Rarity.EPIC, 13, goldReq);
    craftingRecipes.set(gold.name, gold);
    
    // Jewel Crafting
    var amethystReq = [new craftingRequirement.CraftingRequirement(quartz, 10)];
    const amethyst = new craftingItem.CraftingItem("Amethyst", categories[4], 300, 60, rarity.Rarity.COMMON, 14, amethystReq);
    ...
    const pendant = new craftingItem.CraftingItem("Pendant", categories[4], 500, 180, rarity.Rarity.RARE, 15, pendantReq);
    ...
    const necklace = new craftingItem.CraftingItem("Necklace", categories[4], 500, 760, rarity.Rarity.EPIC, 16, necklaceReq);
    craftingRecipes.set(necklace.name, necklace);
    
    // Magic Crafting
    var orbReq = [new craftingRequirement.CraftingRequirement(quartz, 20)];
    const orb = new craftingItem.CraftingItem("Orb", categories[5], 300, 60, rarity.Rarity.COMMON, 17, orbReq);
    ...
    const water = new craftingItem.CraftingItem("Water", categories[5], 800, 360, rarity.Rarity.RARE, 18, waterReq);
    ...
    const fire = new craftingItem.CraftingItem("Fire", categories[5], 1000, 720, rarity.Rarity.EPIC, 19, fireReq);
    ...
    const waterstone = new craftingItem.CraftingItem("Waterstone", categories[6], 1500, 720, rarity.Rarity.RARE, 20, waterstoneReq);
    ...
    const firestone = new craftingItem.CraftingItem("Firestone", categories[6], 1500, 720, rarity.Rarity.EPIC, 21, firestoneReq);
    ...
    const elementstone = new craftingItem.CraftingItem("Elementstone", categories[6], 5000, 1440, rarity.Rarity.LEGENDARY, 22, elementstoneReq);
    ...
    const artifact = new craftingItem.CraftingItem("Artifact", categories[7], 10000, 4320, rarity.Rarity.LEGENDARY, 23, artifactReq);
